defmodule Lava.ShoppingCart do
  @moduledoc """
  ...
  alias Lava.Repo
  alias Lava.Catalog
  alias Lava.ShoppingCart.{Cart, CartItem}
  ...
  def prune_cart_items(%Cart{} = cart) do
    {_, _} = Repo.delete_all(from(i in CartItem, where: i.cert_id == ^cart.id))
    {:ok, reload_cart(cart)}
  end
  ...
  Raises `Ecto.NoResultsError` if the Cart items does not exist.
